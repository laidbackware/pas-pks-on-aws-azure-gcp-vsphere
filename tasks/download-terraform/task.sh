...
LATEST_VERSION=$(curl https://releases.hashicorp.com/terraform/index.json | jq -r '.versions[].builds[].version' | sort -t. -k 1,1n -k 2,2n -k 3,3n -k 4,4n -k 5,5n | egrep -v 'rc|beta' |tail -1)
